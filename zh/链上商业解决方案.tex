...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacitybacktitle=0.6, breakable, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, rightrule=.15mm, bottomtitle=1mm, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{关于本书}, arc=.35mm, toprule=.15mm]
