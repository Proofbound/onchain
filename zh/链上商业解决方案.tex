...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, colback=white, left=2mm, rightrule=.15mm, leftrule=.75mm, breakable, opacityback=0, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{关于本书}, bottomrule=.15mm, opacitybacktitle=0.6]
