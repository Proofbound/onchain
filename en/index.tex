...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacitybacktitle=0.6, left=2mm, bottomrule=.15mm, breakable, opacityback=0, colback=white, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomtitle=1mm, titlerule=0mm, coltitle=black, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{About This Book}, leftrule=.75mm, colframe=quarto-callout-note-color-frame, toprule=.15mm]
