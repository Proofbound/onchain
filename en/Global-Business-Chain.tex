...
\urlstyle{same}
\hypersetup{
  pdftitle={Global Business Chain},
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, rightrule=.15mm, breakable, colback=white, titlerule=0mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{About This Book}, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, bottomtitle=1mm, left=2mm, toprule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, leftrule=.75mm]
...
\caption{An Overview of F2C Wallet}
